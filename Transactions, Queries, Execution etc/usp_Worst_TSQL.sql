...
--http://www.sqlmag.com/Article/ArticleID/100201/sql_server_100201.html
...
BEGIN 
   ...
   RAISERROR('@ORDERBY parameter not APCU, TCPU, AE, TE, EC, AIO, TIO, ALR, TLR, ALW, TWL, APR or TPR',11,1)
   RETURN
 END
 SELECT TOP (@COUNT) 
   ...
   --*****      --,OBJECT_SCHEMA_NAME(st.objectid,dbid) [Schema Name] 
    ...
    ORDER BY CASE 
                ...
                WHEN @ORDERBY = 'TWL'  THEN total_logical_writes  
