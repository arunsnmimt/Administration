...
DECLARE	@mode tinyint /*0=diagnose, 1=Summarize, 2=Index Usage Detail, 3=Missing Index Detail*/
DECLARE	@schema_name NVARCHAR(256)  /*Requires table_name as well.*/
DECLARE	@table_name NVARCHAR(256)   /*Requires schema_name as well. @mode doesn't matter if you're specifying a table.*/
